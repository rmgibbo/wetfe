...
First a pedantic note, using the metaphor: we _do_ both get the same answer. The answer to _every_ existential question is "Yes and no!", which means "Yes, those symbols exist somewhere; and no, they don't exist somewhere, too."
